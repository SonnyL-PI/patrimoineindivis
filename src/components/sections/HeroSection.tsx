...
export function HeroSection() {
  return <>
      ...
      paddingTop: "calc(88px + env(safe-area-inset-top, 0px))"
        ...
        {/* Content */}
        <div className="relative z-10 px-6 pt-6 pb-6" style={{
        paddingBottom: "calc(28px + env(safe-area-inset-bottom, 0px))"
          ...
          {/* Accroche */}
          <p className="text-white text-base font-medium mb-2 animate-fade-up" style={{
          animationDelay: "50ms"
        }}>
          ...
          {/* Sous-titre */}
          <p className="text-accent font-bold text-xl mb-5 animate-fade-up" style={{
          ...
          {/* Paragraphe - 3 lignes */}
          <div className="mb-6 animate-fade-up max-w-[360px]" style={{
          ...
          {/* CTAs */}
          <div className="flex flex-col gap-3 mb-4 animate-fade-up" style={{
          animationDelay: "250ms"
        }}>
            <Button variant="gold" size="lg" className="w-full min-h-[56px] text-base font-bold shadow-xl" asChild>
              <Link to="/contact">
                Demander une étude
...
<Link to="/contact?tab=callback">
          ...
          {/* Micro-texte */}
          <p className="text-sm text-white text-center mb-5 font-medium animate-fade-up" style={{
          ...
          {/* Trust badges */}
          <div className="grid grid-cols-2 gap-x-5 gap-y-3 pt-5 border-t border-white/35 animate-fade-up" style={{
      ...
      paddingBottom: "calc(40px + env(safe-area-inset-bottom, 0px))"
        ...
        <div className="relative z-10 py-16 lg:py-20 px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 max-w-[1600px] mx-auto w-full">
          <div className="max-w-4xl lg:max-w-5xl xl:max-w-6xl">
            ...
            {/* Accroche */}
            <p className="text-white text-lg lg:text-xl xl:text-2xl font-medium mb-4 animate-fade-up" style={{
            animationDelay: "50ms"
          }}>
              Vous souhaitez sortir de l'indivision ?
            </p>
            ...
            {/* Sous-titre */}
            <p className="text-accent font-bold text-xl lg:text-2xl xl:text-[1.75rem] mb-8 animate-fade-up" style={{
            animationDelay: "150ms",
            ...
            {/* Paragraphe */}
            <div className="mb-10 animate-fade-up max-w-2xl relative" style={{
            animationDelay: "200ms"
          }}>
              {/* Subtle reading band */}
              <div className="absolute -inset-x-4 -inset-y-3 rounded-lg pointer-events-none" style={{
              background: "linear-gradient(90deg, hsl(215 30% 8% / 0.35) 0%, hsl(215 30% 10% / 0.15) 70%, transparent 100%)"
            }} />
              <div className="relative">
                <p className="text-base lg:text-lg xl:text-xl text-white leading-[1.75] mb-2">Patrimoine Indivis, première société en France exclusivement dédiée au rachat de parts indivises</p>
                ...
                <p className="text-base lg:text-lg xl:text-xl text-white leading-[1.75]">Rachat de parts indivises mêmes minoritaires sur tout le territoire.</p>
              </div>
            </div>

            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 mb-5 animate-fade-up" style={{
            animationDelay: "250ms"
          }}>
              <Button variant="gold" className="w-full sm:w-auto px-8 lg:px-10 py-4 lg:py-5 text-base lg:text-lg font-bold shadow-2xl min-h-[56px]" asChild>
                <Link to="/contact">
                  Demander une étude
...
<Link to="/contact?tab=callback">
            ...
            {/* Micro-texte */}
            <p className="text-sm lg:text-base text-white font-medium mb-8 animate-fade-up" style={{
            animationDelay: "300ms"
          }}>
              Étude confidentielle — Réponse rapide
            </p>
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap items-center gap-x-8 lg:gap-x-10 gap-y-3 pt-6 border-t border-white/40 animate-fade-up" style={{
            animationDelay: "350ms"
          }}>
              {trustBadges.map((badge, index) => <div key={index} className="flex items-center gap-2.5">
