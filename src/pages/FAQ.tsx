...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Une fois votre dossier complet reçu, nous vous adressons une offre ferme sous 3-4 jours ouvrés. La durée totale de la procédure dépend ensuite de la complexité du dossier et de la réactivité des différentes parties (indivisaires).",
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Pour établir une offre, nous avons besoin de la copie du titre de propriété, ou de l'acte de notoriété, la répartition entre indivisaires et idéalement la valeur du ou des biens.",
      },
    ],
  },
  {
