...
const situations = [{
  ...
  problems: ["Procédure de divorce longue et complexe", "Une ordonnance de non conciliation a été prononcée", "Impossibilité de racheter la part de l'ex-conjoint", "Besoin de liquidité pour repartir"],
