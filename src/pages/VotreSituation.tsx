...
const situations = [{
  ...
  problems: ["Désaccord entre héritiers sur le devenir du bien", "La succession n'est toujours pas close alors que vous avez l'attestation de notoriété", "Besoin de récupérer votre part d'héritage", "Frais de succession à payer"],
  ...
  problems: ["Minorité de blocage empêchant toute décision", "Procédures judiciaires longues et coûteuses", "Bien qui se dégrade faute d'entretien", "Frustration et sentiment d'impuissance"],
  ...
  problems: ["Capital immobilisé dans le bien indivis", "Projet professionnel ou personnel à financer", "Autres indivisaires qui ne souhaitent pas vendre", "Besoin d'argent à court terme"],
