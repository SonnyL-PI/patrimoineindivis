...
const situations = [{
  ...
  problems: ["Aucune indemnité d'occupation payé par l'occupant", "Procédures judiciaires longues et coûteuses", "Bien qui se dégrade faute d'entretien", "Frustration et sentiment d'impuissance"],
