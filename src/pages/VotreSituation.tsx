...
const situations = [{
  ...
  problems: ["Aucune indemnité d'occupation payé par l'occupant", "Bien qui se dégrade faute d'entretien", "Charges et impôts fonciers importants alors que vous n'en profitez pas", "Travaux à prévoir DPE F ou G pour bien occupé"],
