...
const situations = [{
  ...
  problems: ["Refus de vendre le bien par un des coindivisaires", "Décisions bloquées faute de majorité aux 2/3", "Dégradation des relations familiales", "Dégradation du bien qui perd de la valeur"],
