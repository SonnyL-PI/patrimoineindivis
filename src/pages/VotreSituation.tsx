...
const situations = [{
  ...
  problems: ["Refus de vendre le bien par un ou plusieurs des coindivisaires", "Décisions bloquées faute de majorité aux 2/3", "Dégradation des relations familiales", "Dégradation du bien qui perd de la valeur", "Vous ne souhaitez pas transmettre cette situation à vos enfants"],
  ...
  solution: "Grâce à notre expertise, nous vous soumettrons la meilleure option pour sortir de cette situation de façon sécurisée."
}, {
  id: "liquidite",
  icon: Wallet,
  image: liquiditeImg,
  ...
  problems: ["Patrimoine soumis à l'IFI pour un ou des biens qui vous rapportent peu voire rien", "Vous souhaitez rendre vos parts indivises liquides pour de meilleurs placements", "Vous résidez à l'étranger et vous ne souhaitez plus être lié fiscalement à la France"],
  solution: "En vendant vos parts vous pouvez réduire voire supprimer l'IFI. Nous vous proposerons de les racheter rapidement vous permettant ainsi d'optimiser votre fiscalité."
}];
