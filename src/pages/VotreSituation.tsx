...
const situations = [{
  ...
  problems: ["Patrimoine immobilier soumis à l'IFI alors que vous n'avez que des parts indivises", "Vous souhaitez rendre vos parts indivises liquides", "Besoin d'optimiser votre patrimoine global", "Restructuration patrimoniale complexe"],
