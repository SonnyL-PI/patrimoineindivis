...
const situations = [{
  ...
  problems: ["Patrimoine soumis à l'IFI pour un ou des biens qui vous rapportent peu voir rien", "Vous souhaitez rendre vos parts indivises liquides", "Vous résidez à l'étranger et vous ne souhaitez plus être lié fiscalement à la France"],
