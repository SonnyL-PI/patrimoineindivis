...
const situations = [{
  ...
  problems: ["Patrimoine immobilier soumis à l'IFI alors que vous n'avez que des parts indivises", "Part indivise difficile à valoriser fiscalement", "Besoin d'optimiser votre patrimoine global", "Restructuration patrimoniale complexe"],
